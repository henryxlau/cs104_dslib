...
public:
	...
	{
		Node<KeyType, ValueType> * nodePtr = root;
	...
	{
		Node<KeyType, ValueType> * tempNode = root;
		Node<KeyType, ValueType> * tempNodeParent = NULL;
		...
		if (tempNode == NULL)
		{
			tempNode = new Node<KeyType, ValueType> (k,v,tempNodeParent);
			if (root == NULL)
			{
				root = tempNode;
			}
